...
bool intersect(int mn1, int mx1, int mn2, int mx2) {
    return (mn1 < mx2 && mx1 > mn2);
    /* return ((mn1 > mn2 && mn1 < mx2) || (mx1 > mn2 && mx1 < mx2)); */
}
...
void solve() {
    ...
    cout << ((intersect(a, d, g, j) && intersect(b, e, h, k) && intersect(c, f, i, l)) ? "Yes" : "No");
}
